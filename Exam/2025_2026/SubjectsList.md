---
title: List of subjects for ESDM 2025-2026 exam
...
28. Explain what the **deadlock** problem is, based on the following image:
    
    ![](img/Deadlock.png){.id width=55%} \

29. Explain how Lock ordering is a solution to the deadlock problem.
